<template>
  <div id="previewer">
    <div class="bar">
      ...
      <rename-button v-if="user.attrs.perm_rename"></rename-button>
      <delete-button v-if="user.attrs.perm_delete"></delete-button>
      <download-button v-if="user.attrs.perm_download"></download-button>
